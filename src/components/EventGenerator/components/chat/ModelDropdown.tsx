    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          size="sm"
          className={cn(
            "flex items-center gap-1 text-xs px-2 py-1 h-auto border border-gray-200 bg-white shadow-sm",
            className
          )}
        >
          <selectedModel.icon className={`h-3 w-3 ${selectedModel.iconColor}`} />
