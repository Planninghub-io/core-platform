...
interface ILEAVendorListItemProps {
  vendor: ILEAVendor;
}

export const ILEAVendorListItem: React.FC<ILEAVendorListItemProps> = ({ vendor }) => {
  const getPriceRange = () => {
          ...
          <div className="flex-1 space-y-4">
            ...
            {vendor.company && (
              <div className="pt-3 border-t">
                <h4 className="font-medium text-gray-900 text-sm mb-2">{vendor.company.name}</h4>
